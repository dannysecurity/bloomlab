...
func main() {
	...
	fmt.Printf("fill ratio: %.2f%%, inserts: %d, max counter: %d/%d, theoretical FPR: %.4f%%\n",
		cf.FillRatio()*100, cf.ApproximateCount(), cf.MaxCounter(), cf.CounterLimit(), cf.TheoryFPR()*100)
