...
var (
	...
	ErrInvalidCounterWidth = errors.New("bloom: counter width must be 2, 4, 8, 16, 32, or 64")
)
...
type Config struct {
	...
	// CounterWidth selects packed 2-bit (2), 4-bit (4), uint8 (0 or 8), uint16 (16), uint32 (32), or uint64 (64) counters.
	CounterWidth uint8
...
// WithCounterWidth returns a copy with the given per-bit counter width (2, 4, 8, 16, 32, or 64).
